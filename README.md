...
이 저장소는 AI에 입력하여 Role Play를 하거나 일관된 상호작용을 위해 구조화된 스키마 기반 프롬프트를 텍스트 파일로 모아놓았습니다.

각 스키마는 `.txt` 또는 `.md` 형식이며, 붙여넣는 것 만으로도 쉽게 적용할 수 있습니다. `template.txt`와 `template.md`가 기본 구성 레이아웃입니다. 
